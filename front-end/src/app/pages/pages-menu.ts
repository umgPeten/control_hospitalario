...
export const MENU_ITEMS: NbMenuItem[] = [
  { title: 'E-commerce', icon: 'shopping-cart-outline', link: '/pages/dashboard', home: true, },
  { title: 'IoT Dashboard', icon: 'home-outline', link: '/pages/iot-dashboard', },
  { title: 'FEATURES', group: true,},
  { title: 'Layout', icon: 'layout-outline', children: [
  ...
  { title: 'Forms', icon: 'edit-2-outline', children: [
  ...
  { title: 'UI Features', icon: 'keypad-outline', link: '/pages/ui-features', children: [
  ...
  { title: 'Modal & Overlays', icon: 'browser-outline', children: [
  ...
  { title: 'Extra Components', icon: 'message-circle-outline', children: [
  ...
  { title: 'Maps', icon: 'map-outline', children: [
